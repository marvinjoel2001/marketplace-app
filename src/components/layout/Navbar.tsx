          ...
          <div className="flex items-center justify-between gap-4 lg:gap-8">
            ...
            <div className="flex items-center space-x-3 shrink-0">
              ...
              <Link href="/" className="flex items-center space-x-2.5 group">
                {/* VM Badge matching mockup */}
                <div className="w-10 h-10 rounded-full bg-[#00D1B2] flex items-center justify-center text-white font-black text-sm shadow-md group-hover:scale-105 transition-transform shrink-0">
                  VM
                </div>
